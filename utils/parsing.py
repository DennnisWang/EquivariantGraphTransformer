...
def add_common_args(parser):
    ...
    group.add_argument("--llm", help="Whether to use 3D molecular representation learning frame", action="store_true")
    group.add_argument("--new", help="Whether to use new architecture", action="store_true")
...
def add_preprocess_args(parser):
    ...
    group.add_argument("--max_seq_len", type=int, default=1024)
...
def add_train_args(parser):
    ...
    group.add_argument("--kernel",type=str,default="")
